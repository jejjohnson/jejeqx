...
def calculate_relative_vorticity_sf(ds, variable: str = "psi", normalized: bool = True):
...
def calculate_relative_vorticity_uv(
    ds, variables: List[str] = ["u", "v"], normalized: bool = True
):
...
def calculate_absolute_vorticity_uv(
    ds, variables: List[str] = ["u", "v"], normalized: bool = True
):
