...
class AlongTrackDM(pl.LightningDataModule):
    ...
    def preprocess(self):
        ...
        # rescale time
        ds = time_rescale(ds, freq_dt=self.time_freq, freq_unit=self.time_unit, t0=self.t0)
    ...
    def setup(self, stage=None):
        ...
        self.ds_train = SpatioTempDataset(spatial_coords=xtrain, temporal_coords=ttrain, data=ytrain)
        self.ds_valid = SpatioTempDataset(spatial_coords=xvalid, temporal_coords=tvalid, data=yvalid)
