...
FILE_GULFSTREAM_SSH_OI_NADIR = (
    "https://s3.us-east-1.wasabisys.com/melody/osse_data/oi/ssh_NATL60_4nadir.nc"
)
FILE_GULFSTREAM_SSH_SWOT = "https://s3.us-east-1.wasabisys.com/melody/osse_data/data/gridded_data_swot_wocorr/dataset_swot.nc"
FILE_GULFSTREAM_SSH_OI_SWOT = (
    "https://s3.us-east-1.wasabisys.com/melody/osse_data/oi/ssh_NATL60_swot.nc"
)
...
class XRDataModule(pl.LightningDataModule):
    ...
    def _load_data(self, path, decode: bool = False):
        ...
        ds = xr.open_dataset(path, decode_times=False).assign_coords(
            time=lambda ds: pd.to_datetime(ds.time)
        )
