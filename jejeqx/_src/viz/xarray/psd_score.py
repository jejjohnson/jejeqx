...
def plot_psd_isotropic_score(
    ...
    **kwargs,
    ...
    fig, ax, secax = plot_psd_isotropic(da=da, scale=scale, ax=ax, **kwargs)
    ...
    ax.scatter(
        resolved_scale, 0.5, color=color, marker=".", linewidth=5, label=label, zorder=3
    )
...
def plot_psd_spacetime_score_wavelength(da, space_scale="km", psd_units=None, ax=None):
