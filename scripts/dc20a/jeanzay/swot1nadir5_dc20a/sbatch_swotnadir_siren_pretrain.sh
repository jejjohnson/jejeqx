#!/bin/bash
#SBATCH --job-name=s_sine_pt                # name of job
...
#SBATCH --output=/gpfsscratch/rech/cli/uvo53rl/logs/nerf4ssh_dc20_swot1nadir5_siren_%j.log      # name of output file
#SBATCH --error=/gpfsscratch/rech/cli/uvo53rl/errs/nerf4ssh_dc20_swot1nadir5_siren_%j.err       # name of error file
#SBATCH --export=ALL
