...
#SBATCH --output=/gpfsscratch/rech/cli/uvo53rl/logs/nerf4ssh_dc20_swot1nadir5_mlp_%j.log      # name of output file
#SBATCH --error=/gpfsscratch/rech/cli/uvo53rl/errs/nerf4ssh_dc20_swot1nadir5__mlp_%j.err       # name of error file
#SBATCH --export=ALL
...
# srun /gpfswork/rech/cli/uvo53rl/projects/jejeqx/scripts/dc20a/jeanzay/swot1nadir5_dc20a/train_swotnadir_mlp.sh
