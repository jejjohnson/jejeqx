#!/bin/bash
#SBATCH --job-name=osse_nadir4                # name of job
...
#SBATCH --output=/gpfsscratch/rech/cli/uvo53rl/logs/nerf4ssh_natl60_nadir4_siren_%j.log      # name of output file
#SBATCH --error=/gpfsscratch/rech/cli/uvo53rl/errs/nerf4ssh_natl60_nadir4_siren_%j.err       # name of error file
#SBATCH --export=ALL
...
srun python /gpfswork/rech/cli/uvo53rl/projects/jejeqx/scripts/dc20a/main.py \
    ...
    evaluation=natl60 \
    pretrained=default \
    dataset="natl60_nadir4" \
    lr_scheduler=warmup_cosine \
    ++data.batch_size=10_000 \
    ++logger.mode="offline" \
